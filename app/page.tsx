    ...
    <div className="min-h-screen bg-[#fdfcf0] text-[#5d4037] font-serif p-4 md:p-8 flex flex-col items-center">
      ...
      <main className="max-w-4xl w-full grid md:grid-cols-2 gap-8 bg-white border-[12px] border-[#d4a373] rounded-[3rem] p-6 md:p-10 shadow-[20px_20px_0px_#faedcd]">
        ...
        <div className="flex flex-col justify-center">
          <div className="mb-8">
            <h3 className="text-4xl font-bold mb-6 text-center md:text-left leading-tight">{auction.product_name}</h3>
            
            <div className="bg-[#fefae0] border-2 border-dashed border-[#d4a373] rounded-3xl p-8 text-center shadow-inner">
              <span className="text-xs uppercase font-bold tracking-widest opacity-60 font-sans">Current Highest Bid</span>
              <div className="text-6xl font-black text-[#606c38] my-3 tabular-nums">{auction.current_bid} ₺</div>
          ...
          <form onSubmit={submitBid} className="space-y-4">
            <input 
              className="w-full p-4 rounded-2xl bg-stone-50 border-2 border-stone-100 focus:border-[#d4a373] outline-none transition-all shadow-sm" 
            ...
            <div className="relative">
              <input 
                className="w-full p-4 pl-10 rounded-2xl bg-stone-50 border-2 border-[#d4a373] focus:ring-4 focus:ring-[#faedcd] outline-none font-bold text-xl transition-all shadow-sm" 
